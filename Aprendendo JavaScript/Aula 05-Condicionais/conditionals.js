...
if (idadeMaria >= 18){
    ...
    console.log(`Faltam ${anosFaltante} anos para Maria poder dirigir.`);
}
...
if (idadePessoa >= 0 && idadePessoa <= 12){ // não esquecer de escreever a variável nos dois lados
...
if (x % 5 === 0){
    console.log(`O número ${x} e múltiplo de 5`);
}
...
switch (diaDaSemana){
    case 0:
        nomeDoDia = "Domingo";
    break; // break é um comando que se nao é colocado no swift, continua processando e só para no ultimo
    case 1:
        nomeDoDia = "Segunda";
    break;
    case 2:
