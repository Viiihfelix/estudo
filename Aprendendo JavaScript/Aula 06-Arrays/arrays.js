...
const listaDeConvidados = ["Matheus", "Izabelli", "Amanda", "Paula"]; // length - 1 
// length - 1 -> para aparecer o nome certo, contagem começa do numero zero, por isso diminui 1
...
console.log("Covidado numero 4:", listaDeConvidados[listaDeConvidados.length - 1]);
